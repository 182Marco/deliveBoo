...
var expenses = relatedOrders.map(function (e) {
  return e.price;
});
...
var labelsName = ordersLastName.concat("AVERAGE");
var pricesChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](expensessChart, {
  type: "bar",
...
/***/ 2:
/*!********************************************!*\
  !*** multi ./resources/js/jsBack/chart.js ***!
  \********************************************/
